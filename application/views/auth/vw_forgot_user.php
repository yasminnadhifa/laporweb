  ...
  <div id="app">
    <section class="section">
        ...
        <div class="col-lg-5 col-md-12 col-12 col-sm-12 order-lg-1 min-vh-100 order-2 bg-white">
          <div class="p-4 m-3">
           <br>           <br>           <br>           <br>            <br>            <br>            <br>
            ...
            <h4 class="text-dark" style="margin-left: auto;">Lupa Password</h4>
			<br>    
      <?= $this->session->flashdata('message'); ?>     
			...
			<span style="margin-top: 200px; text-align: center;"><a href="<?= base_url('Auth') ?>"  style="color:red;">Kembali Login</a> </span>
